...
// Boilerplate to define Arbiter in different environments
( function( root, factory ) {
  'use strict';

  var name = 'Arbiter';

  // Detect AMD/RequireJS environments and register as an annomyous module
  ...
  // Other "global" enviornemnts such as browsers. Attempt to expose itself
  // using the revealing module pattern.
  } else {
    root[ name ] = factory( function( x ) {
      return root[ x ];
    } );
  }
